 ...
 */
export function ComponentBars({ result }: { result: AnalysisResponse }) {
  const data = [
    { name: 'Text similarity', value: result.text_similarity, weight: result.weights.text_similarity },
    { name: 'Skill match', value: result.skill_match ?? 0, weight: result.weights.skill_match },
    { name: 'Keyword match', value: result.keyword_match, weight: result.weights.keyword_match },
